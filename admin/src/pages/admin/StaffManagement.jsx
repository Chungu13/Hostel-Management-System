...
import {
    ...
    Trash2, ShieldAlert, Plus, Loader2, CreditCard
} from 'lucide-react';
                            ...
                            >
                                <div className="flex justify-between items-start mb-6">
                                    ...
                                    <div className="flex gap-2">
                                        <button onClick={() => openEditModal(person)} className="p-2 glass text-primary hover:bg-primary/10 rounded-lg">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm mb-6">
                                    ...
                                    <div className="flex items-center gap-2 text-text-muted">
                                        <CreditCard className="w-4 h-4 text-primary" /> {person.ic}
                                    </div>
                                    <div className="flex items-center gap-2 text-text-muted">
                                        <MapPin className="w-4 h-4 text-primary" /> {person.address}
                                    </div>
                                </div>
